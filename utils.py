# http://forums.fast.ai/t/keras-2-released/1956/21

from __future__ import division,print_function
import math, os, json, sys, re

# import cPickle as pickle
import pickle # replaced by "import cPickle as pickle" because cpickle does not work in python 3
...
# http://forums.fast.ai/t/keras-2-released/1956/21
# https://github.com/fchollet/keras/issues/5870
#[Deprecated]# from keras.regularizers import l2, activity_l2, l1, activity_l1
from keras.regularizers import l2, l1
from keras.layers.normalization import BatchNormalization
from keras.optimizers import SGD, RMSprop, Adam
#[Deprecated]# from keras.utils.layer_utils import layer_from_config
...
def plots(ims, figsize=(12,6), rows=1, interp=False, titles=None):
    if type(ims[0]) is np.ndarray:
        ...
        # change dimension into 'channels-last'
        if (ims.shape[-1] != 3):
